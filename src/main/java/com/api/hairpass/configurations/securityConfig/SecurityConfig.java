    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .permitAll()
                        .requestMatchers(HttpMethod.POST,"/api/v1/agendamento/criar-agendamento")
                        .permitAll()
                        .requestMatchers(HttpMethod.POST,"/api/v1/cadastro/funcionario")
                        .permitAll()
                        .requestMatchers(HttpMethod.POST,"/api/v1/cadastro/salao")
                        .permitAll()
                        .requestMatchers(HttpMethod.POST,"/api/v1/cadastro/usuario")
                        .permitAll()
                        .requestMatchers(HttpMethod.POST,"/api/v1/cadastro/servico")
                        .hasRole("USUARIO_SALAO")
